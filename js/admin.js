/* ============================================================
   ...
   الملف ده مبيتحطش في index.html — site.js بيحمّله on-demand أول مرة
   حد يفتح #/admin (checkAdminRoute) عشان الـ ~44KB دول متنزّلوش على
   كل زائر للموقع. أول ما الملف ده يشتغل بيعرّف checkAdminRoute
   الحقيقية مكان البديل المؤقت اللي في site.js.
============================================================ */
